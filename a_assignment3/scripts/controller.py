...
#from a_assignment3.srv import Coordinates	       #service for 1
from a_assignment3.srv import Kb_input   	       #service for 2 and 3


def first_choice():
    #calls the service "coordinates" and sends the coordinates to the manage_input(request) function in case_1.py
    print("choice 1")
...
def second_choice():
    #if the user selects mode 2 it will send 1 to the manage_input(request) function in case_2.py
    print("choice 2")
...
def third_choice():
    #if the user selects mode 3 it will send 2 to the manage_input(request) function in case_2.py
    print("choice 3")
